 ...
 * EmergencySimulation
 *
 * Interactive, client-side demo of the crowd-finding model. It visualizes a simplified AoI-driven
 * search scenario and plots time series produced by the in-browser simulation engine.
 */
